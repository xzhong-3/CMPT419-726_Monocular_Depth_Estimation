## code adapted from https://github.com/pytorch/vision/blob/master/torchvision/models/resnet.py with minor changes
...
def resnet50(pretrained=False, **kwags):

    model = ResNet(Bottleneck, [3, 4, 6, 3], **kwags)
    if pretrained:
